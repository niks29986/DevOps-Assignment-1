...
To start the application you can just run (`java -jar target/springboot-app-*.jar`), then you can call the API by using the following curl (shown with its output):
